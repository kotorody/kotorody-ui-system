  ...
  return (
    ...
    >
      ...
      >
        <div
          className="aba"
          style={{ width: "386px", height: "42px", display: "flex" }}
        >
          <div
            className="aba1"
            style={{
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className="faba-box-inside-botom">
                    <img
                      width="100%"
                      height="100%"
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <div className="見出し" style={{ fontWeight: "bold" }}>
                    最も興味のあるサービス*
                  </div>
                  {[
                    "AItoChat（チャットボット）",
